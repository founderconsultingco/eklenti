...
Haftada bir de toplu araştırma var, pazartesi sabahı on dakika: nişin iş ilanı araması ve reklam kütüphanesi bakışı. İkisi de tek arama, sonuçları bütün listeye dağılıyor. Bu, gözlemi olmayan adayların gözlem kazandığı yer.
