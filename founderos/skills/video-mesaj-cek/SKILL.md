...
- İlk hafta günde üç video, bir saat; eksik kalan iki temas o hafta diğer iki yazılı kanala geçer. İkinci haftadan itibaren beş, doksan dakika, ve beş taban olur. Beş sabit bir tavan değil taban: üçüncü haftadan sonra, senaryoya alıştıysan ve günün diğer sayıları tutuyorsa video sekize, sonra ona, en fazla on beşe çıkar. Artan pay diğer iki yazılı kanaldan alınır, ana kanalın yetmişi sabit kalır: video sekizse yazılı yirmi iki, video onsa yirmi, video on beşse on beş. Toplam hep yüz.
