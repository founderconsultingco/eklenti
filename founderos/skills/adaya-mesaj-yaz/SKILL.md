...
Dört kanal var: telefon, e-posta, Instagram, video. Dördü de burada yönetilir. Videonun metnini video-mesaj-cek yazar; ama hangi adaya, ne zaman video gideceği ve videodan sonra hangi kanalın geleceği burada yazılıdır.
...
- Kendini küçültme yok: "bir şey satmaya çalışmıyorum" yasak.
- Muhtaç görünme yok. Ton şu: "ilgilenirsen ne güzel, ilgilenmezsen sorun değil".
- Dolgu kelimesi yok.
- İlk hayırda tek soru sorarsın (aşağıda, "İlgilenmiyorum"), ikinci soru yok. Israr yok, kovalama yok.
...
Sabit hali, her nişte geçerli: "Görüşmede size sunum yapmayacağım. Yeni bir talebin işletmenize nereden geldiğine ve nerede beklediğine birlikte bakacağız. Düzeltilecek bir yer varsa gösteririm, yoksa onu da açıkça söylerim."

Daha güçlü hali, yalnız gerçekten yapacaksan: "Görüşmeden önce bölgenizdeki birkaç işletmenin telefon ve mesaj akışına bakacağım, sizinkiyle farkını göstereceğim." Bu cümleyi bakmayacaksan kurmazsın. Bakmayı görüşmenin içinde canlı yapacaksan da söylenir, ama öyle söylenir: "Görüşmede birlikte iki üç rakibinize bakacağız."

Yasak olan: "size özel bir demo hazırladım" (hazırlanmadıysa), "rakiplerinizi inceledim" (incelenmediyse), "size şu kadar randevu getiririm" (hiçbir durumda). Kaynağı ne olursa olsun sayı vaadi verilmez.

**İşleve göre "ne yaptığın" cümlesi.** Beşinci adımdaki cümle sabit değil; işletmenin en çok kaybettiği yere göre değişir. Aşağıdaki liste İş modeli'ndeki on üç işlevden çıkar ve sırası kartın müşteri yolculuğuna göre seçilir. Her işlev için üç satır var: telefonda söylenecek sonuç cümlesi, merak cümlesi (konuşma tıkanırsa), keşif sorusu (işleyiş sorusunun yerine geçebilir). Üçü de aynı işlevi anlatır, üçü birden söylenmez.

Kural: işlevin adı işletmeciye söylenmez. "Cevapsız arama dönüşü kuruyorum" değil, "telefona yetişemediğinizde ne olduğunu anlatıyorum". Teknik ad senin içindir.

1. **Yeni başvuruya hızlı dönüş.** Sonuç: "Formdan ya da WhatsApp'tan yeni bir talep geldiğinde siz müsait olana kadar beklemiyor, ilk dönüşü dakikalar içinde yapıyor ve ne istediğini öğrenip size bırakıyor." Merak: "Bir talebin geldiği andan size hazır bilgiyle düştüğü ana kadar olan yolu gösterebilirim." Keşif: "Sizde yeni bir talep geldiğinde ilk dönüş genelde ne kadar sürüyor?"
2. **Cevapsız arama sonrası mesaj.** Sonuç: "Telefona yetişemediğinizde arayan kişiye kısa süre içinde mesaj gidiyor, ne için aradığını soruyor ve uygunsa randevuya yazıyor." Merak: "Cevapsız kalan bir aramanın bir dakika sonra nasıl konuşmaya döndüğünü göstereyim." Keşif: "Yoğunken cevaplayamadığınız aramalara şu anda nasıl geri dönülüyor?"
3. **Mesaj asistanı.** Sonuç: "WhatsApp'a, Instagram'a ya da sitenizden yazan müşteriye siz işteyken cevap veriyor, ne istediğini alıyor ve randevuya yazıyor. Fiyat vermiyor, karışık konuyu size aktarıyor." Merak: "Gece yazan bir müşterinin sabah önünüze hazır bilgiyle düştüğü hali gösterebilirim." Keşif: "Mesai dışında gelen mesajlara ertesi gün mü dönülüyor?"
4. **Adayı değerlendirme ve yönlendirme.** Sonuç: "Yazan herkesi takviminize doldurmuyor. Önce ne istediğini, nerede olduğunu ve hangi hizmetle ilgilendiğini soruyor; uygun olmayanı randevuya yazmıyor." Merak: "Takviminizin yalnız gerçekten uygun kişilerle dolduğu hali gösterebilirim." Keşif: "Randevu alanların ne kadarı gerçekten sizin işinize uygun çıkıyor?"
5. **Otomatik takip.** Sonuç: "Bilgi alıp cevap vermeyen kişi unutulmuyor. Belirli aralıklarla bir daha yazıyor, cevap gelince konuşma kaldığı yerden devam ediyor." Merak: "Bugün karar vermeyen kişinin iki hafta sonra nasıl geri döndüğünü gösterebilirim." Keşif: "Fiyat verip cevap alamadığınız kişiler şu anda nasıl takip ediliyor?"
6. **Gelen aramayı karşılayan sesli asistan.** Sonuç: "Telefon altyapınız uygunsa açılmayan aramayı karşılayan, ne istediğini sorup randevuya yazan bir hat da kurulabiliyor." Bu cümle yalnız İş Beyni'nde bu parçanın kurulduğu yazıyorsa söylenir. Uygunluk sorulursa: "Kurulumda bakıp söylüyorum, şimdiden söz vermeyeyim." Keşif: "Telefonu kim açıyor, açamadığınız saat hangisi?"
...
**"Nasıl çalışıyor?" sorusuna cevap.** Karşı taraf ayrıntı sorduğunda teknik anlatıma girmezsin; telefonda anlatılan sistem olduğundan karmaşık duyuluyor ve konuşma orada ölüyor. Üç parçalı tek cevap: arkada ne olduğunu bir cümleyle kabul et, onun gördüğü tarafı anlat, göstermeye bağla.

"Arka tarafta birkaç sistem birlikte çalışıyor, otomasyon ve yapay zekâ var. Ama sizin göreceğiniz taraf basit: talep geliyor, sistem ilk konuşmayı başlatıyor, gerekli bilgiyi alıyor ve uygun kişiyi takviminize yazıyor. Teknik tarafı da anlatırım ama gerçek akış üzerinde göstermek çok daha anlaşılır oluyor."

Yapay zekâ cümlenin baş kahramanı yapılmaz. İşletmeci yapay zekâ satın almıyor, kaçan müşterisini geri istiyor. "Yapay zekâ mı?" diye sorarsa saklamazsın, kabul edip sonuca dönersin.

**Baştan sona örnek arama.** Aşağıdaki konuşma altı adımın, itirazların ve randevu almanın tek parça hali. İşletmeci sabırsız ve şüpheci; gerçek aramaların çoğu böyle gidiyor. Ezberlenmez, ritmi için okunur.

Klima ve kombi servisi, Bursa. Denetim kartındaki bulgu: salı akşamı yedide aranmış, açılmamış. Kurulu parça: mesaj asistanı ve cevapsız arama sonrası mesaj.

> **Sen:** Merhaba, ben Murathan, Bursa'dan arıyorum. Numaranızı Haritalar'daki işletme sayfanızdan aldım. Serkan Bey siz misiniz?
> **O:** Benim, buyurun.
> **Sen:** Plansız aradım, kısa tutacağım. Yirmi saniyede neden aradığımı söyleyeyim, alakasızsa kapatalım. Uygun mudur?
> **O:** Söyleyin.
> **Sen:** Salı akşamı yediye doğru sizi bir kere aradım, açılmadı. Onun için arıyorum. Yoğunken telefona yetişemediğinizde müşteri ne yapıyor, tekrar mı arıyor, mesaj mı yazıyor?
> **O:** Valla çoğu tekrar aramıyor. Sahadayız, akşam bakıyoruz.
> **Sen:** Ben tam bunun için bir sistem kuruyorum: telefona yetişemediğinizde arayan kişiye kısa süre içinde mesaj gidiyor, ne için aradığını soruyor ve uygunsa randevuya yazıyor. Siz işteyken WhatsApp'a yazana da aynı şekilde dönüyor. Bursa'da bu ay ilk üç servisle başlıyorum.
...
> **O:** WhatsApp olsun.
> **Sen:** Şu an konuştuğumuz numara, doğru mu?
> **O:** Doğru.
> **Sen:** E-posta adresinizi de alayım, daveti oraya da bırakayım.
> **O:** serkan@ornekklima.com.
> **Sen:** serkan@ornekklima.com, doğru aldım mı?
> **O:** Doğru.
> **Sen:** Yarın üçte sizi arıyorum, hazır olun. Kapatınca gelen mesaja EVET yazın, yerinizi kesinleştireyim. İçinde üç dakikalık kısa bir video var, bu akşam izleyin, görüşmeye hazır gelmiş olursunuz.
> **O:** Tamam, iyi günler.
...
Her kanal satırı dört değerden birini alır:
...
- **"Araba kullanıyorum / müşterideyim."** Söyle: "Dikkatinizi dağıtmayayım, ne zaman uygun?" Gün al, kapat.
- **"Hemen yazın beni."** Bu sahte evet, gelmez. Söyle: "Açıkçası size uyar mı bilmiyorum, önce yirmi dakika tanıyalım." Saat al.
- **"Çalışanlarımın yerini mi alacak?"** Söyle: "Hayır. Çalışanınız sahadayken cevapsız kalan mesajı karşılıyor, o kadar." Soruya dön.
- **"Bozulursa ne olacak?"** Söyle: "Haftada bir kontrol ediyorum, sorun çıkarsa aynı gün bakıyorum; hesaplar sizin adınıza açık, istediğiniz gün kapatırsınız." Soruya dön. Söylenmeyen: olmayan yedek, olmayan destek hattı.

### Gelmeyen randevu

Saat gelip beş dakika geçince ara: "Görüşmede bekliyorum, her şey yolunda mı?" Ulaşamazsan iki gün sonra tek takip, yeni randevu iste. E-posta zinciri yok. Aday "sonra" değil, "görüşme ayarlandı" aşamasında kalır. İki denemeden sonra "sonra" aşamasına geçer.
...
Niş kartına: "sahadan dolacak" bölümüne gerçek cevap oranı ve çalışan açılış cümlesi.
...
Randevu alınınca gorusmeye-getir devralır: e-posta ve takvim daveti daha telefondayken gönderilir, adaya "evet" yazdırılır. Görüşme yapılınca gorusmeyi-analiz-et itirazları ve kancayı buraya geri yazar. İlk kanıt hikâyesi çıkınca yedinci gün takibi ve e-posta imzası gerçek rakamla güncellenir.

İşaretler (FounderOS okur, sen bir şey yapmazsın):
- İki gün sıfır temas.
- Denetimsiz bir adaya temas edilmiş: o temas sayılır ama işaret düşer; ikinci kez olursa sabah bloğu denetim kartlarıyla başlar.
