...
Teslimatın ilk modülü. Modül, FounderOS'un belli bir işi yapan parçasıdır. Bu modül para hesaba geçtiği anda başlar. Kurulum haftası yoğundur; haftalık görüşme ve iş kanıtı ise rapor gününe, yirmi birinci güne kadar bu modülden yürür. Üç işi var: karşılama, kurulum görüşmesi, ilk haftanın görünürlüğü.
...
- Sıfırıncı gün, para hesaba geçtiği an. Beş iş:
...
- Yedinci gün: karşılama formu ve duran havuz onayı elinde olur. Gelmezse yirmi bir gün, onun verdiği günden başlar.
...
İş Beyni'nden (senin hakkında bilinen her şeyin yazıldığı dosya): sistemin adı, Kademe 2'nin (görüşmede satılan tam sistem) bu nişteki içeriği, güvence ve şartı, kurulum ve aylık rakam, teslimatın bu nişe uyarlanmış yirmi bir günlük takvimi.
...
İkincisi bu nişin yasal sınırları:
- emlakta, izin kaydı olmayan numaraya kampanya mesajı gitmez;
- sigortada özel bilgiler için açık rıza gerekiyor. Açık rıza, kişinin "bu bilgimi şu iş için kullanabilirsiniz" diye ayrıca verdiği izindir. Sigortada yenileme hatırlatmasının ticari ileti sayılıp sayılmadığı belirsiz. Ticari ileti, satış amacı taşıyan toplu mesajdır;
...
8. Eski müşteri listesi nerede duruyor: telefon rehberi, WhatsApp, randevu defteri, muhasebe programı, Excel.
...
Ön koşullar: alt hesap açılmış olur (müşteri için CRM'de açılan ayrı bölüm; onu FounderOS tarafı açar, sana faturalanır), karşılama formu dolmuş olur, sözleşme imzalanmış olur.
...
Gündem yedi madde, bu sırayla:
1. Neden buradayız: kayıp rakamını geri okursun, yirmi bir günün takvimini ekranda gösterirsin.
2. Güvence ve şartını sesli söylersin: yirmi birinci günde rapor; giriş izinleri bu görüşmede, karşılama formu ve duran havuz onayı yedinci güne kadar. Geç verirse yirmi bir gün onun verdiği günden başlar. Bir şeyi daha burada söylersin: eski müşteri listesinde İYS izni olan numara çıkmazsa o listeye mesaj gönderemeyiz, o parça kapsam dışı kalır ve güvencenin sonucuna sayılmaz. Sonuç cümlesini de burada sesli okursun: yirmi birinci günün raporunda üç sayı görünecek (gelen talep, yazılan randevu, ulaşılan eski müşteri); kuramadığımız bir parça olursa o satır boş kalır ve sayılmaz; yazılan satırların hepsi sıfırsa ikinci ay ücreti alınmaz. O ay bittiğinde üç yoldan biri seçilir: kapsamı daraltıp devam, normal ücretle devam, ya da sözleşmedeki yazılı bildirimle ayrılma. Bu cümle sözleşmede ve onay belgesinde hazır durur. Görüşme sığmazsa bu madde ikinci görüşmeye kalmaz, izinlerle birlikte birinci görüşmede kalır.
...
Kural: hesaplar müşterinin adına kalır. Şifre alınmaz, davetle giriş izni alınır. Giriş izni, müşterinin kendi hesabından seni davet ederek verdiği yetkidir. Gerekçeyi müşteriye söylersin: hesabın sahibi sensin, ben ayrılırsam her şey sende kalır.
...
Telefon: mevcut numarasına dokunulmaz, müşteriye yeni numara alınır. Cevapsız aramanın yeni numaraya nasıl bağlanacağı musteri-sistemini-kur'un işi; burada sadece kararı ve iznini alırsın.
...
Liste müşterinindir. Sadece onun talimatıyla kullanılır; iş biterse silinir.

Yasal adım: mesaj gönderilmeden önce İYS kontrolü yapılır. İYS, bir işletmenin insanlara toplu mesaj gönderebilmesi için gereken resmi izin kaydıdır. Sorguyu sen yapmazsın; müşteri kendi hesabından yapar ve sonucu sana yazılı verir. Onayı olmayan numaraya mesaj gitmez; o müşteriler için yalnızca gelen aramaya dönüş kalır. Gönderilecek metinleri müşteri yazılı onaylar ve her mesajda listeden çıkma yolu bulunur.

Müşterinin kendi müşterilerini bilgilendirme borcu ona aittir. Senin de bir sorumluluğun olup olmadığı hukukçuya sorulur; cevap gelene kadar listeyi yalnız müşterinin yazılı talimatıyla kullanırsın.
...
Yirmi bir günün takvimini ekranda gösterir ve üç şey söylersin:
...
"Bitti" tanımı yazılıdır: altıncı günde canlı, takvimin son gününde rapor. Tam zamanlıysan o gün yirmi birinci gündür; işin yanında çalışıyorsan takvim yirmi sekiz güne yazıldığı için o gün yirmi sekizinci gündür. Hangisi olduğunu ekranda gösterir ve tarihini söylersin. Güvenceyi tetikleyen şey raporun kendisi değil, raporun sayılarıdır: yazılan satırların hepsi sıfırsa ikinci ay ücreti alınmaz.
...
İlk müşterinin bütün teslim süresinde, yani sıfırıncı günden yirmi birinci güne kadar günlük temas hedefin düşer: tam zamanlıysan yüz yerine elli, işin yanında çalışıyorsan kırk yerine yirmi. Sadece kurulum haftası değil, yirmi bir günün tamamı. Garanti şartı bu günlerin hepsini hariç tutar.
...
Yirmi bir günlük teslim bir kişinin yaklaşık elli saatini alıyor. Tam zamanlıysan bu saatler gündüzden çıkar ve takvim değişmez. İşin yanında çalışıyorsan aynı elli saat akşamdan ve hafta sonundan çıkar. O yüzden bu bölüm var.

Hangi iş hangi pencereye giriyor:
- Kurulum görüşmesi ve bütün müşteri görüşmeleri: kurulum bloğu. Sende akşam ya da cumartesi.
- Sistem kurulumu, ikinci günden dördüncü güne: akşam bloğu, her akşam bir saat.
- Beşinci günün testi: akşam bloğuna sığmaz, hafta sonuna kayar. On iki senaryo ve yirmi sekiz tur tek oturumda bitmez.
...
Kaç güne uzuyor: hesap açık. Hafta içi beş gün, her gün yaklaşık iki saat (akşam bloğunun bir saati, artı temas kırktan yirmiye indiği için saha bloğunda boşalan süre). Cumartesi üç saat. Haftada on üç saat eder. Elli saat bölü on üç, yaklaşık dört hafta. Yani teslim yirmi bir günde değil, yirmi sekiz günde biter.

Bunun karşılığı şu: teslim takvimini yirmi bir güne değil yirmi sekiz güne yazarsın, rapor günü o takvimin son günüdür ve güvence o günden ölçülür. Müşteriye söylenme anı bellidir: kurulum görüşmesinin birinci maddesinde, takvimi ekranda gösterirken. Gecikince değil, baştan. "Yirmi bir gün" deyip sonra kaydırmak, baştan yirmi sekiz demekten çok daha pahalıya patlar.
...
Para gelince: "Para geldi. Şimdi sessizlik olmayacak. Onay belgesi hazır, sen gönder. Kurulum görüşmesi yarın, kurulum bloğunda; saatini müşteri seçti. Bugün iki işin var: formu doldurmadıysa hatırlat, izin videosunu gönder."
İşin yanında çalışıyorsan, kurulum görüşmesinden önce: "Takvimi yirmi bir güne değil yirmi sekiz güne yazdım. Sebebi basit: bu iş elli saat, senin elinde akşamlar ve cumartesi var. Bunu bugün söyleyeceksin, üçüncü hafta gecikince değil. Baştan söylenen tarih düzendir, sonradan söylenen tarih mazerettir."
...
Görüşmeden önce: "Bir saat, yedi madde. En önemlisi üçüncüsü: izinler. İzinleri alamadan bu görüşmeden çıkma, sonra iki hafta peşinde koşarsın."
...
Bilgi dosyasına: karşılama formunun cevapları, görüşme kaydından çıkan notlar, alınan ve alınamayan izinler, tek muhatap, iletişim kanalı ve haftalık görüşme günü, listenin nerede durduğu ve ne zaman geleceği, beklenti cümleleri, nişe özel yasal sınır.
CRM'e: kurulum görüşmesi yapıldı ve tarihi, kayıt izni var mı, izin durumu, liste durumu, yirmi bir günün başlangıç tarihi ve şart geç yerine getirildiyse kayan tarih, kayan aylık tahsilat günü, haftalık görüşme günü.
...
- Karşılama formu görüşmeye kadar dolmadıysa: görüşmenin ilk on beş dakikasında birlikte doldurulur, görüşme bir buçuk saate çıkar. Yedinci güne kadar hiç gelmezse yirmi bir gün o günden başlar.
- Müşteri görüşmeye gelmezse: beş dakika sonra ararsın, aynı gün ikinci saat verirsin. İki denemede olmazsa yirmi bir gün başlamaz, sebebi bilgi dosyasına yazılır.
...
- Yedinci gün geldi, liste yok: yirmi bir gün kayar, müşteriye tek cümleyle bildirilir.
...
- İşin yanında çalışıyorsun ve ilk müşteri kapandı: teslim takvimi yirmi sekiz güne yazılır, günlük temas hedefi yirmi bir gün boyunca kırktan yirmiye iner, kilit sayaçları yarı hızda işler.
