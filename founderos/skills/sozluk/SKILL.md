...
- Aday listesi sayfası: Klasördeki `adaylar.html`; öğrencinin aday havuzunu gördüğü tek ekran. İki sekmesi var: Liste (bütün havuz; ipuçları Türkçe, bugün sırada olan yeşil, günü geçmiş turuncu, satıra tıklayınca ayrıntı) ve Saha modu (bugün aranacaklar kart kart, arama kartıyla; her kartta sonuç düğmeleri). Öğrenci Excel açmaz. Sayfayı ve `adaylar.csv`'yi FounderOS'un aday aracı yazar (aday-listesi-dosyasi).
