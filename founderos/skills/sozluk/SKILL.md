...
- Marka şablonu: `marka-sablonu.html`. Kitin bütün panolarını ve her varlığın tam piksel ölçüsünü taşıyan hazır dosya. FounderOS onu kopyalar ve yalnız `window.MARKA` veri bloğunu doldurur; tasarım her öğrencide yeniden yapılmaz.
