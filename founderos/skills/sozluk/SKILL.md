...
- Sesli prova: Provayı yazarak değil, mikrofonla konuşarak yapman. Cümleyi sesli kurmakla yazmak aynı şey değil; telefonda söyleyeceğin cümle provada da ağzından çıkar. Karşı tarafı yine FounderOS oynar, sen konuşursun.
...
- Güvence: Müşteriye verdiğin söz: rapor gününde ([21/28]. gün) rapor; raporda üç sayı görünür (sisteme gelen talep; nişin yolculuğuna göre sistemin yazdığı randevu ya da takip ettiği teklif; eski müşteri listesinde ulaşılan kişi), kurulamayan parçanın satırı boş kalır ve sayılmaz, sistemin yazdığı randevu sıfırsa ikinci ay ücreti alınmaz. Tam metni ve iki sürümü İş modeli bölümünde; her belge oradan okur. Şartı: müşteri giriş izinlerini kurulum görüşmesinde, karşılama formunu ve duran havuz onayını yedinci güne kadar verir. Eski müşteri listesinde İYS onaylı numara çıkmazsa geri çağırma parçası güvencenin sonucuna sayılmaz. Sayı sözü asla verilmez.
...
- Aday denetimi: Bir işletmeye ulaşmadan önce, o işletmenin müşterisini nerede kaçırdığını dışarıdan bakarak çıkarma işi. İki hâli var: yirmi saniyelik hızlı denetim (satırların çoğu veri servisinden hazır geliyor, öğrenci okuyup onaylıyor) ve beş dakikalık derin denetim.
...
3. Güvence şartlı. "Rapor gününde rapor; sistemin yazdığı randevu sıfırsa ikinci ay ücreti alınmaz" sözü müşterinin kendi adımlarına bağlı: giriş izinleri kurulum görüşmesinde (en geç ikinci gün), karşılama formu ve duran havuz onayı yedinci güne kadar. Bir de şu var: bir parça mevzuat yüzünden ya da müşterinin kendi adımını atmaması yüzünden hiç kurulamıyorsa, o parça kapsam dışıdır ve güvencenin sonucuna sayılmaz. Bilinen haller: eski müşteri listesinde İYS izinli numara çıkmaması, Google işletme profilinin doğrulanmamış olması, sağlık nişinde hukukçu onayının gelmemesi, QR kodun bastırılıp asılmaması. Bunlar kurulum görüşmesinde sesli söylenir ve onay belgesinin "neyi yapmıyorum" başlığına yazılır. Sözleşmede yazılı, kurulum görüşmesinde sesli söylenir.
...
18. Arkanda ekip yok, teklifin de öyle konuşulmaz. Öğrenci tek kişi çalışıyor ve bu bir eksiklik değil, satış üstünlüğü; "on müşterisi olan biri sizin telefonunuza bakmaz" cümlesi bunun için işliyor. Hiçbir modül öğrenciye "ekibe ilet", "teknik ekip hazırlar", "ekibin onayını al" demez; bu işlerin hepsini öğrenci kendisi yapıyor, FounderOS de ona bunun için yardım ediyor. Adaya karşı "biz" demek serbesttir, işletme sahiplerinin çoğu zaten bir işletmeyle konuştuğunu varsayar; ama olmayan bir ekip, olmayan bir ofis ve olmayan bir çalışan anlatılmaz. Bilmediği bir soru geldiğinde uydurmaz ve "ekibimize soracağım" diye zaman kazanmaz; söylediği şey şudur: "Bunu kontrol edip bugün yazılı döneceğim." Söz verdiği günün içinde gerçekten döner. Dönemeyeceği bir tarih verilmez.
19. Yedek yol denenmeden açılmaz. Bir modülün yedek yolu, ana yolun gerçekten denendiği ve başarısız olduğu durumlar içindir. Ana yol çağrılmadan yedek yola geçmek en sessiz hata türü: öğrenci çalışan bir sistemin yerine elle çalışmaya başlıyor, kimse bir şeyin bozuk olduğunu fark etmiyor ve kayıt tutulmadığı için sorun hiç düzelmiyor. Kural şu: ana yol çağrılır, hata gelirse bir kez daha denenir, yine hata gelirse sebep öğrenciye tek cümleyle söylenir ve İş Beyni'nin açık işler bölümüne tarihiyle yazılır. Ancak ondan sonra yedek yol açılır. Bir yedek yolun adımları, ana yolun adımlarının yanına yazılmaz; modülün yedek yol bölümünde durur. Yan yana duran iki yol, sırayla uygulanan iki adım gibi okunuyor.
