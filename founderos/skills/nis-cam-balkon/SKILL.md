...
Müşteri yolculuğu: teklif (keşif randevusu, sonra teklif ve kapora). Teslimat bu yola göre kurulur; sahada tersi görülürse "Sahadan dolacak" bölümüne yazılır.

**Gerçek fiyatlar ve kapasite.** Yayınlanmış bir fiyat sayfasından cam balkon m2 fiyatları: katlanır/akordiyon şeffaf 4.750 TL, ısıcamlı 7.000 TL, sürgülü 7.500 TL (a1cambalkon.com, 2026). Sahadan gerçek teklifler daha dağınık: bir forum kullanıcısı Aralık 2024'te metre başı 3.500 ile 7.500 TL arası teklifler almış, bir başkası 14 metrekare için 39.500 TL teklif almış (DonanımHaber forum). PVC pencerede Armut'un kendi verisine göre fiyat aralığı 1.000 ile 150.000 TL kadar geniş; örnek bir iş Ankara'da 8 pencere için 19.999 ile 111.111 TL arası teklif almış (armut.com/fiyatlari/pvc-pencere_1584). Panjurda tipik iş 10.000 ile 35.000 TL bandında (armut.com/fiyatlari/panjur_2623). Sineklik küçük iş, bir şikayette geçen tutar 3.500 TL (Mycam Esenler, sikayetvar.com).
...
İkincisi: kapora alıp işe geç başlama, müşteri tarafında "oyalanma" teması çok sık geçiyor. Kendi kelimeleriyle: "sürekli oyalandım, sözler verildi ama kimse gelmedi" (MK Cam Balkon, Kayseri, 30.000 TL peşinat, sikayetvar.com). "Sipariş üzerinden 35 iş günü geçmesine rağmen hâlâ montaj yapılmadı ve süreç boyunca sürekli oyalanıyorum" (Duru Panjur, Samsun, sikayetvar.com). Benzer örnekler: Ay Dekor Eskişehir 41 gün, Polat Yapı Bakırköy 8 ayda tamamlanmama, Salih İmrak PVC 235.000 TL iade talebi.

Üçüncüsü: satış sonrası iletişim kopması, "Sineklik Takılmadı, Şirket Cevap Vermiyor Ve Cenaze Bahaneleri Sunuyor" (Mycam, Esenler, sikayetvar.com). Not: "telefon açılmıyor" temalı doğrudan cevapsız arama şikayeti bu taramada azdı, baskın tema teklif sonrası sessizlik ve kapora sonrası oyalanma oldu.

**Sezon.** Kartta sezon bilgisi yok, sahadan dolacak. Şimdilik yıl boyu çalışıyor kabul ediliyor.

**Rekabetin şekli.** Armut'ta Türkiye genelinde 5.764 PVC pencere ustası, 1.880 panjurcu kayıtlı (armut.com fiyat sayfaları). İstanbul'da sadece cam balkon kategorisinde 3.343 firma var. Türkiye geneli toplam işletme sayısı (Google Haritalar toplamı) bulunamadı, bilinmiyor, sahadan dolacak. Meta Reklam Kütüphanesi'ne erişilemedi, görülemedi; ama neredeyse her firma sitesinde "ücretsiz keşif" vurgulu blog/SEO içeriği çok yaygın (egecambalkon.org, cambalkon.net gibi örnekler), yani dijital pazarlamaya yatırım var, doğrudan reklam görülemedi. Zincir yapı büyük ölçüde üretici markalar üzerinden: Albert Genau kendi sitesinde "tek işinin cam balkon olması ve sadece kendi bayileri üzerinden satış yapması" ilkesini yazıyor (albertgenau.com); yani çoğu yerel işletme aslında bir üretici markanın (Winsa, Albert Genau, Egepen gibi) bölge bayisi, kendi markası değil.

**Kim karar veriyor.** Doğrudan kanıt sınırlı. Şikayetlerde "bayi" ve "yetkili servis" ifadeleri geçiyor, büyük projelerde müteahhit üzerinden gidilen örnekler de var. Küçük yerel bayide muhtemelen sahibi ya da ortağı karar veriyor ama bu net kanıtlanamadı, bilinmiyor, sahadan dolacak.

**İşletmecinin gerçek dertleri.** Bu turda işletmecinin kendi ağzından forum/röportaj bulunamadı, bilinmiyor, sahadan dolacak. Dolaylı bir ipucu: üretici markaların bayilik sayfaları "23 parça bayi paketi", "aylık müşteri yönlendirme" gibi destekler vurguluyor (albertgenau.com), bu da bayilerin talep akışı konusunda üreticiye bağımlı olduğunu düşündürüyor; kesin değil.

Sözlüğü: keşif, ücretsiz keşif, ölçü, teklif, montaj, bayi, peşinat, metrekare, iş günü, garanti

İç sesi: "Keşfe gidip ölçüyü alıyorum, teklifi veriyorum, o insan bir daha dönmüyor; iş de dönüp dolaşıp üreticinin yönlendirdiği müşteriye kalıyor."

**Açılış cümlesi.** Teklif verip kaybolan havuz üzerinden: "Geçen ay kaç eve keşfe gittiniz de iş çıkmadı? O insanların çoğu hâlâ pencere ya da cam balkon yaptırmadı, sadece siz unutuldunuz." Bu cümle itiraz üretmiyor çünkü rakamı işletmeci zaten biliyor: İstanbul'da bin firma teklif veriyor, iş beşte birine bile kalmıyor.

**Duran havuz.** Üç grup var, birincisi en güçlü. Teklif alıp kaybolanlar: keşif genelde ücretsiz verildiği için bu liste hızlı birikiyor, kayıt WhatsApp ve telefon geçmişinde duruyor olmalı. Garanti süresi devam edenler: kapı, pencere, cam balkon ve elektrikli panjurda yasal garanti 2 yıl (Garanti Belgesi Yönetmeliği, madde 18, tuketici.ticaret.gov.tr), bu süre boyunca bakım/kontrol araması meşru bir sebep. Yenileme zamanı gelenler: eski pencere, yıpranmış conta, aşınmış mekanizma; sektör bakım/temizlik konusunda çok içerik üretiyor ama sistemli hatırlatma yapıldığına dair kanıt yok.
...
En güçlü üç itiraz: keşfi de telefonu da ben yapıyorum, keşif olmadan fiyat veremem, teklif verdiğim kişi zaten kararsız.

"Ben zaten ücretsiz keşif veriyorum, telefonu ben açarım." İstanbul'da bin üç yüzden fazla firma aynı havuzdan besleniyor, biri "100 teklife çoğu cevap veremedi" diyor; ilk dönen kazanıyor.

"Fiyatı telefonda veremem, keşif lazım." Haklısın, sektör zaten böyle çalışıyor, fiyat aralığı 1.000 ile 150.000 TL arasına yayılıyor. Asistan fiyat vermez, ölçü ve fotoğraf toplayıp randevuya çevirir.
...
**Kaynaklar.**
- https://www.a1cambalkon.com/cam-balkon-fiyatlari-m2/
- https://forum.donanimhaber.com/cam-balkon-genel-danisma-tartisma-konusu--160276612
- https://armut.com/fiyatlari/pvc-pencere_1584
- https://armut.com/fiyatlari/panjur_2623
- https://armut.com/istanbul-cam-balkon
- https://egepenakcayapi.com/blog/cam-balkon-montaji-ne-kadar-surer/
- https://egepenakcayapi.com.tr/blog/pvc-pencere-fiyatlari-2026/
- https://www.sikayetvar.com/cam-balkon
- https://www.sikayetvar.com/mk-cam-balkon-kayseri/mk-cam-balkon-kayseri-surekli-oyalandim-sozler-verildi-ama-kimse-gelmedi-ve-somut-adim-atilmadi
- https://www.sikayetvar.com/duru-panjur-samsun/duru-panjur-hala-montaj-yapilmadi-ve-surec-boyunca-surekli-oyalaniyorum
- https://www.sikayetvar.com/pencere/pvc
- https://www.sikayetvar.com/pen/pvc
- https://www.sikayetvar.com/sineklik
- https://www.sikayetvar.com/armut/cam-balkon/teklif
- https://tavsiyeforumu.com/konu/hangi-pvc-markasi.9975/
- https://eksisozluk.com/cam-balkon--2407893
- https://tuketici.ticaret.gov.tr/data/5e819a8e13b876a1b04c7a4a/Garanti%20Belgesi%20Y%C3%B6netmeli%C4%9Fi.pdf
- https://www.kocaelibarisgazetesi.com/haber/21335354/evinde-cam-balkonu-olanlara-kotu-haber-yargitay-cezayi-acikladi
- https://www.birgun.net/haber/cam-balkonlar-sokulecek-mi-cam-balkon-yaptirma-sartlari-neler-yeni-cam-balkon-duzenlemesi-726544
- https://www.albertgenau.com/tr/Cambalkon-Imalat-Bayilik
