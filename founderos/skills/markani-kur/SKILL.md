...
**Sağlam ve yüksek kontrastlı.** Usta ve saha işleri için: klima ve kombi servisi, oto servis, elektrik, haşere, cam balkon, tadilat, temizlik. Koyu zemin, kalın ve geniş başlık yazısı, tek güçlü vurgu rengi, keskin köşeler. Sebebi: bu sektörde güven, işini bilen ve lafı uzatmayan görüntüden geliyor.

**Sakin ve temiz.** Sağlık ve randevulu işler için: diş kliniği, estetik, güzellik salonu, pilates, kuaför. Açık zemin, ince ve dengeli yazı, çok boşluk, yumuşak köşeler, tek nötr vurgu. Sebebi: bu nişlerde yasal sınırlar sert, iddialı görüntü hem yasak hem ters tepiyor.

**Ölçülü ve kurumsal.** Para ve belge işleri için: emlak, sigorta, oto galeri, düğün organizasyon, fotoğraf stüdyosu. Orta kontrast, düz ve okunaklı yazı, iki renk artı gri skala, hafif yuvarlatılmış köşeler. Sebebi: bu sektörlerde müşteri güven algısı zaten kırık, abartılı görüntü şüphe artırıyor.
...
3. Claude on altı panoyu tek tahtada üretir. Bu on beş yirmi dakika sürer, beklersin.
...
Talimatın içinde yazılı ama bilmen lazım, çünkü çıkanı sen kontrol edeceksin:
...
Süs. Her eleman bir iş yapacak. Bir şeyin orada neden durduğunu söyleyemiyorsan çıkarılır.
...
MARKA
İsim: [iş adı]
İş: [nişin adı] için, kaçan talebi randevuya çeviren sistemi kuran ve işleten tek kişilik iş.
Tek cümlelik pozisyon: [Dönüşüm Cümlesi]
Sistemin adı: [sistemin adı]
Sistem parçaları: [Kademe 2'nin bu nişteki içeriği]
Hedef müşteri: [ideal müşteri tanımı], karar verici [kartın karar verici satırı]
Pazar ve dil: Türkiye, Türkçe. Şehir: [şehir]
Satılan şey teknoloji değil sonuç. Marka bir yazılım şirketi gibi değil, sistemi kuran ve işleten operatör gibi durmalı. Tek kişilik bir iş bu; büyük ajans taklidi yapma, güvenilir ve işini bilen bir usta gibi dur.
Kullanım alanları: Instagram, WhatsApp Business, e-posta, satış sayfası, onay belgesi ve sunum, kartvizit.

GÖRSEL YÖN (bu kilitli, kendi zevkine kaymayacaksın)
Yön: [seçilen yönün adı]
Kurallar: [o yönün kuralları: zemin, kontrast, başlık yazısının karakteri, vurgu rengi sayısı, köşe yarıçapı, boşluk kullanımı]
...
PANOLAR (bu sırayla, on altı tane)
01 Kapak: marka adı, tek cümlelik pozisyon, tarih ve sürüm.
...
03 Logo sistemi: ana logo, yatay hali, dikey hali, sadece yazı hali, tek harfli küçük hali. Her varyantın altında nerede kullanılacağı. Logo sektör resmi olmak zorunda değil; akış ve sistem fikri daha güçlü.
04 Logo kullanım kuralları: etrafında bırakılacak boşluk (küçük halin genişliği birimiyle), en küçük boyut (ekranda piksel, baskıda milimetre), açık zemin, koyu zemin, fotoğraf üstü, tek renk ve gri hali.
05 Yanlış kullanımlar: en az sekiz hatalı örnek, her birinin üstünde kırmızı çarpı. Orantı bozma, döndürme, gölge ekleme, renk değiştirme, düşük kontrastlı zemin, sıkıştırma, efekt ekleme, kalabalık fotoğraf üstü.
06 Renk sistemi: ana renk, destek renk, vurgu rengi, beş kademeli nötr gri, üç durum rengi (olumlu, uyarı, hata). Her renk için HEX, RGB, CMYK. Altında 60/30/10 kullanım oranı ve metin-zemin kontrast oranları; erişilebilirlik eşiğini geçenleri işaretle.
07 Tipografi: başlık ve metin aileleri, Google Fonts'tan ücretsiz ve Türkçe karakterleri tam destekleyen olanlar. H1'den küçük nota kadar punto, satır yüksekliği, harf aralığı, ağırlık. Türkçe karakter test satırı: ğĞüÜşŞıİöÖçÇ. Bir de yanlış eşleştirme örneği.
08 Grafik dil: köşe yarıçapı, çizgi kalınlığı, ikon stili ve on iki örnek ikon, arka plan dokusu, akış şeması çizim stili, veri gösterim stili, fotoğraf seçme ve seçmeme kuralı, ızgara ve boşluk sistemi.
09 Arayüz parçaları: buton (ana, ikincil, çerçevesiz; normal, üstüne gelince, pasif), giriş alanı, kart, etiket, tablo satırı, istatistik kutusu, alıntı bloğu. Açık ve koyu tema.
10 Sayfa düzeni: satış sayfasının başlık bölümü (başlık, kısa açıklama, ana düğme ve ikinci düğme), kart görünümü, bölüm araları ve alt bölüm. Sayfanın kendi bölümleri siteni-kur'da kuruluyor; bu pano yalnızca görünümü belirler.
11 Instagram paylaşım şablonu: 1080x1350, beş kareli örnek (kanca, problem, sistem, kanıt, çağrı) ve boş hali.
12 Dikey video: 1080x1920 üç kapak varyantı, altyazı stili, hikâye şablonu, soru ve anket şablonu.
13 YouTube ve WhatsApp: video kapağı üç varyant (yüz artı metin, sadece metin, ekran görüntüsü artı metin), kanal görseli, WhatsApp Business profil görseli ve işletme açıklaması düzeni.
14 Satış materyali: onay belgesi kapağı ve iç sayfası, kanıt hikâyesi sayfası (öncesi ve sonrası rakam düzeni), sunum kapağı, içerik slaytı, kapanış slaytı.
15 Kurumsal set: kartvizit ön ve arka, e-posta imzası (üç satır: ne yaptığın, kanıt satırı, takvim linki), fatura ve sözleşme anteti, görüntülü görüşme arka planı.
16 Hızlı referans: tek sayfada renk kodları, yazı tipi adları, en küçük logo boyutu, beş madde yapılacak, beş madde yapılmayacak.

METİN KURALLARI
Bütün örnek metinler gerçek olacak, yer tutucu metin kullanma. Cümleler [nişin adı] sahibinin diliyle yazılacak, onun kelimeleriyle: [kartın işletmeci sözlüğünden dört beş kelime].
Türkçe metinlerde çeviri kokan kalıp yok. Kısa fiil cümleleri, konuşma diline yakın. Uzun çizgi kullanma.
Sayı sözü verme. "Ayda şu kadar randevu" gibi bir cümle hiçbir panoda geçmeyecek.
...
Şablon estetiği: sebepsiz renk geçişi, üç sütunlu boş kart dizisi, her şeyin ortalanması, gereksiz gölge.
Dekoratif olsun diye konulmuş hiçbir eleman. Her eleman bir iş yapacak.
[Sağlık nişindeyse ek: tedavi sözü, hasta görseli, öncesi sonrası düzeni, "kesin sonuç" ve "en iyi" iddiaları hiçbir panoda geçmeyecek.]
...
3. On altı pano aynı sistemi mi kullanıyor. Bir panoda köşeler yuvarlak, diğerinde keskinse tahta bozulmuş demektir, düzelttirirsin.
