...
### Adım 1: WhatsApp iş hesabı ve telefon (30 dakika)

Dün telefon numaranı yazdık ve sayfanın düğmesi o numaraya gidiyor. Bugün o numarayı iş için hazır hale getiriyoruz.

1. Telefonuna WhatsApp Business (WhatsApp iş hesabı) uygulamasını indir; normal WhatsApp'ın yanında ayrı bir uygulama olarak durur. Arama yapacağın numarayla aç. Normal WhatsApp'ın aynı numaradaysa uygulama numarayı taşımayı teklif eder; taşı, sohbetlerin kaybolmaz.
2. Profili doldur: işletme adı olarak dün seçtiğin iş adı, kategori olarak "Danışmanlık", açıklama olarak Dönüşüm Cümlen, profil fotoğrafı olarak marka klasöründeki logo. Adres ve site satırını sitenin adresi yayına çıkınca ben söylerim, bugün öğleden sonra.
3. "Uzakta mesajı" (away message) ve "karşılama mesajı" (greeting message) ayarlarını aç. Metni ben veriyorum: "Merhaba, ben [adın]. Mesajınızı aldım, bugün içinde dönüyorum." İkisine de aynı metin.
4. Kontrol: sayfanın taslağındaki "Görüşme ayarla" düğmesine kendi telefonundan bas. WhatsApp iş hesabın açılıp mesaj kutusu geliyorsa yol açık. Gelmiyorsa numarayı bana yaz, düğmeyi düzeltiyorum.

Bu hesap kontrol listesinin birinci maddesi: "kendi numaranla arama yapabiliyorsun, WhatsApp iş hesabın açık ve mesaj gidiyor."
...
Sıradaki: aynı gün, sayfanın yayını (siteni-kur), sonra pazar doğrulaması (nisi-dogrula arka planda), akşam tanıdık listesi (tanidik-listesi-cikar).
