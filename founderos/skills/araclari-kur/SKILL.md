...
İkinci günün tek modülü. Modül, FounderOS'un belli bir işi yapan parçasıdır. Yol Haritası'nın birinci aşamasının ikinci adımı: temeli kur.

Bugün hesap açıyorsun. Alet almıyorsun, sistem kurmuyorsun. Üç saat.

Neden bugün: dün rakamları kurduk, bugün o rakamların yazılacağı yeri açıyoruz. Yarın kime satacağını seçeceğiz ve seçtiğin anda liste çıkarman gerekecek; listeyi hangi yolla çıkaracağını bugün seçip deniyoruz.
...
Başka bir şey okumaz. Niş yarın seçiliyor, teklif ve fiyat daha sonra. Bugünün işi bunlardan bağımsız.
...
**Bir: Claude masaüstü uygulaması.** FounderOS burada çalışıyor, İş Beyni burada duruyor.
...
### Bugün alınmayanlar ve sebepleri

Programları birbirine bağlayan ara programlar alınmıyor. Hiç. CRM'in kendi akışları bu işi zaten yapıyor. Akış, bir olay olunca kendiliğinden çalışan adım zinciri demek: randevu alındığında hatırlatma göndermek gibi. Müşterin yokken bunları kurmak boş vakit geçirmek.
...
### Adım 1: Claude masaüstü uygulaması (30 dakika)
...
5. Ayarları gir: arama kelimesi olarak kendi şehrinde herhangi bir kategori ("Bursa kuaför" gibi), ülke Türkiye, dil Türkçe, sonuç sayısı 10. Nişin yarın belli olacak, bugün ne yazdığın önemli değil. Kutuların adları İngilizce; hangi kutunun hangisi olduğunu çıkaramazsan ekran görüntüsünü at.
...
3. Eklentiyi aç ve Claude hesabınla gir. Masaüstü uygulamasında kullandığın hesabın aynısı.
...
5. Denemesi: Google Haritalar'ı aç, kendi şehrinde herhangi bir kategoriyi arat ("Bursa kuaför" gibi), eklentiye ilk on işletmenin adını, telefonunu ve web sitesini bir tabloya yazdır. Tablo geldiyse yol açık.
...
Geriye tek kalem kalıyor: Claude aboneliği. Tutarını ödeme ekranında göreceksin; masraf tablosuna o rakamı sen yazıyorsun. Birinci günün tablosunun ilk bölümü bugün kesinleşiyor.
...
Bitince: "Dört parça kurulu, liste yolun belli. Yarın kime satacağını seçiyoruz."

## 7. Ne yazar

İş Beyni'ne: CRM bölümünün adresi, bağlanan Google hesabı, işaretlenen çalışma saatleri, arama yapacağın numara, seçtiğin liste yolu ve seçim tarihi, birinci yolu seçtiysen hesabın ve kalan kredi ile liste çıkaran programın anahtarı, ikinci yolu seçtiysen eklentinin kurulduğu tarayıcı ve verilen izinler, denemenin dosyası ve tarihi, sesli mesaj metni, Claude aboneliğinin aylık tutarı, bütçe merdiveninin bu basamağında hangi kalemin hangi güne ertelendiği.
