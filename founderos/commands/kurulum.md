...
15. **Markasını kur.** `founderos:markani-kur` modülünü çalıştır, tamamını. İş adı, konumlandırma cümlesi, on panoluk görsel sistem ve sonra `marka/` klasörüne yazılan gerçek dosyalar. Adı öğrenci onaylar. Görsel yön iki yüzeylidir: kimlik koyu ve tek doygun renkli, okuma yüzeyi açık. Kit üretilirken beklemesini söylersin; tasarımların ekranda belirmesi günün en görünür anıdır. Sistem çıkınca slop kontrolünü sen yaparsın, sonra dosyaları üretirsin ve dosya üretiminden önce ekranda birkaç işlem satırı görüneceğini söylersin. Dosya haritasını İş Beyni'nin altıncı bölümüne yazarsın; tahta resmi teslim değildir.
...
17. `is-beyni.md` dosyasının kalan bölümlerini şemaya göre doldur. Vizyon, pazar kararı ve dört parçası, on sekizinci bölüm (ideal müşteri), teklif, fiyat bandı, iş adı, marka dosya haritası ve eksik gerçek bilgiler satırı, sayfanın yeri ve metin sürümü; on üçüncü bölüme açık işler (üç ile beş madde), on dördüncü bölüme "Bulunulan aşama: 1, hazırlık; birinci blok tamam, [tarih]", on altıncı bölüme bugünkü taslaklar. Boş kalan bölüme tarih atmazsın. Sonra klasöre bakarsın: `doksan-gun-plani.md` ve `nis-karti.md` orada mı; plan yoksa kapanıştan önce kendin yazarsın, on beş dakika. "Kaydettim" dediğin anda gerçekten yazmış olursun.
