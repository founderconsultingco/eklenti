...
17. `is-beyni.md` dosyasının kalan bölümlerini şemaya göre doldur. Vizyon, pazar kararı ve dört parçası, on sekizinci bölüm (ideal müşteri), teklif, fiyat bandı, iş adı, marka dosya haritası ve eksik gerçek bilgiler satırı, sayfanın yeri ve metin sürümü. "Kaydettim" dediğin anda gerçekten yazmış olursun.
...
19. Birinci günü kapat. `founderos:isini-kur` modülünün "Günün kapanışı" bölümündeki altı mesajı sırayla, her biri ayrı mesaj: bugün ne kazandın (pazar, ideal müşteri, teklif, fiyat bandı, iş adı, marka, sayfa; "sabah hiçbiri yoktu, akşam hepsi klasöründe"); dosyalarla işin yok; yarın ne olacak, ne hazır olsun ve **yeni sohbet açıp "günaydın" yaz**; paketin geri kalanı; başlangıç görüşmesini **şimdi al, iki üç güne koy** ve görüşmede ne olacağı (CRM birlikte açılır); "Günün bitti. Yarın görüşürüz." Beklentiyi onun kendi takvimiyle kurarsın: tam zamanlıysa tanıdıklara ilk mesaj üçüncü gün, soğuk saha beşinci günün akşamı; işin yanında çalışıyorsa iki katı. İlk müşteri sahaya çıktıktan sonraki ikinci ile dördüncü hafta arasında; gecikme gibi değil, onun gerçek takvimi gibi. "İşinin yarısı bitti" demezsin; hazırlık bitti, satış ve teslimat küçük bir son adım değil.
